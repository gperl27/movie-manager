...
{
	if (region._.F === region.ae.F)
	{
		return 'on line ' + region._.F;
	}
	return 'on lines ' + region._.F + ' through ' + region.ae.F;
}
...
var author$project$Main$init = function (_n0) {
	return _Utils_Tuple2(
		{M: _List_Nil, N: _List_Nil, P: _List_Nil, Q: ''},
		author$project$Main$sendSearch(''));
};
var author$project$Main$Error = {$: 0};
...
var author$project$Main$Movie = F4(
	function (filename, filepath, exists, folder) {
		return {T: exists, U: filename, ag: filepath, V: folder};
	});
				...
				elm$json$Json$Encode$object(
					_List_fromArray(
						[
							_Utils_Tuple2(
							'filename',
							elm$json$Json$Encode$string(movie.U)),
							_Utils_Tuple2(
							'filepath',
							elm$json$Json$Encode$string(movie.ag)),
							_Utils_Tuple2(
							'exists',
							elm$json$Json$Encode$bool(movie.T)),
							_Utils_Tuple2(
							'folder',
							elm$json$Json$Encode$string(movie.V))
						])))
			]));
	var str = A2(elm$json$Json$Encode$encode, 0, json);
	return author$project$Main$toBackEnd(str);
...
var author$project$Main$ChooseFolder = {$: 1};
...
var author$project$Main$computeFolders = F2(
	function (allFolders, chosenFolders) {
		return A2(
			...
			function (x) {
				return {
					O: A2(elm$core$List$member, x, chosenFolders),
					G: x
				};
			},
			allFolders);
									...
									[
														...
														[
															...
															_List_fromArray(
																[
																	...
																	_List_fromArray(
																		[
																			_Utils_Tuple2('is-primary', l.O)
																		])),
																	elm$html$Html$Events$onClick(
																	l.O ? author$project$Main$UnclickFolder(l.G) : author$project$Main$ClickFolder(l.G))
																]),
															_List_fromArray(
																[
																	elm$html$Html$text(l.G)
																]))
														]));
											},
											A2(author$project$Main$computeFolders, model.N, model.M))),
										A2(
										elm$html$Html$input,
										_List_fromArray(
											[
										...
										_List_fromArray(
											[
												...
												_List_fromArray(
													[
														elm$html$Html$Attributes$class('unstyled')
													]),
												A2(
													elm$core$List$map,
													function (l) {
																				...
																				[
																					...
																					_List_fromArray(
																						[
																							...
																							elm$html$Html$Attributes$disabled(!l.T)
																						]),
																					_List_fromArray(
																						[
																							A2(
